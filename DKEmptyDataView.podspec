#
#  Be sure to run `pod spec lint EmptyDataView.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "winterrain5" => "derrichshi@foxmail.com" }
  # Or just: spec.author    = "winterrain5"
  # spec.authors            = { "winterrain5" => "derrichshi@foxmail.com" }
